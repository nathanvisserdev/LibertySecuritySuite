...
struct CheckPermissionsView: View {
    @StateObject private var viewModel = CheckPermissionsViewModel()
        ...
        VStack(spacing: 0) {
            ...
            ScrollView {
                VStack(spacing: 15) {
                    ...
                    PermissionStatusRow(title: "Notifications", icon: "bell.badge.fill", status: viewModel.permissionStatuses["Notifications"] ?? "Not Checked", isConfigured: true, configNote: nil, action: viewModel.checkNotifications)
