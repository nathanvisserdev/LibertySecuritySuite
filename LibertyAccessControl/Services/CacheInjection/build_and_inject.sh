...
echo ""
echo "   a) System tccd (to revoke specific app):"
echo "   sudo TCCD_REVOKE_TARGET='com.example.app' DYLD_INSERT_LIBRARIES=$(pwd)/tccd_hook.dylib /System/Library/PrivateFrameworks/TCC.framework/Support/tccd system &"
echo ""
echo "   b) User tccd (to revoke specific app):"
echo "   TCCD_REVOKE_TARGET='com.example.app' DYLD_INSERT_LIBRARIES=$(pwd)/tccd_hook.dylib /System/Library/PrivateFrameworks/TCC.framework/Support/tccd &"
echo ""
echo "   c) System tccd (observation only):"
